...
const feature = new Feature()
  ...
  .setConfig('resolvers', [resolvers])
  .setConfig('middlewares', [tokenMiddleware])
  .setConfig('afterwares', [tokenAfterware])
  .setConfig('connectionParams', [connectionParam])
  .setConfig('rootComponentFactory', [req => <CookiesProvider cookies={req ? req.universalCookies : undefined} />]);
